...
class DebugLogger implements DebugLoggerInterface {
   ...
   * @var array<mixed>
   */
  public static array $smtpSettings = [
    'host' => '',
    'sender' => '',
    'sender_name' => '',
    'port' => '',
   ...
   * @inheritdoc
   */
  public function debug(string|\Stringable $message, array $contenData = [], $fileName = "debug"): void {
    $this->logger->pushHandler(new RotatingFileHandler($this->getFileDir() . "/$fileName.log", 7));
    $this->logger->notice($message, $contenData);
  }
   ...
   *
   * {@inheritdoc}
   * @see \Stephane888\Debug\Logger\DebugLoggerInterface::error()
   */
