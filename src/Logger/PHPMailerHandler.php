...
class PHPMailerHandler extends MailHandler {
   ...
   */
  public function __construct(PHPMailer $mailer, Level $level = Level::Error, bool $bubble = true) {
   ...
   * @param array<mixed> $records The array of log records that formed this content.
   *
   * @return void
   */
