...
Interface DebugLoggerInterface {
   ...
   * @param array $contenData
   *        The context you want to add in the log (eg: an array of data)
   ...
   *        The name of the log file
   */
  public function alert($messageError, $subject, array $contenData = [], $fileName = "alert");
